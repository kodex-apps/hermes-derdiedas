...
const loadedWordList = [{article: 'das', word: 'Haus', isCurrentWord: true, correctWord: null},{article: 'die', word: 'Frau', isCurrentWord: false, correctWord: null}, {article: 'der', word: 'Mann', isCurrentWord: false, correctWord: null}, {article: 'das', word: 'Interesse', isCurrentWord: false, correctWord: null}, {article: 'der', word: 'Meister', isCurrentWord: false, correctWord: null}, {article: 'die', word: 'Bremse', isCurrentWord: false, correctWord: null}, {article: 'der', word: 'Junge', isCurrentWord: false, correctWord: null}, {article: 'das', word: 'Kind', isCurrentWord: false, correctWord: null}, {article: 'die', word: 'Mermelade', isCurrentWord: false, correctWord: null}, {article: 'das', word: 'Ziel', isCurrentWord: false, correctWord: null}];
	...
	const handleChange = event => {
		...
		if (validArticles.includes(input)) { 
			if (input.slice(-3) === currentWord.article) {
				...
				if (currentWord.correctWord === null) wordList[wordList.findIndex(e => e.isCurrentWord)].correctWord = true;
				...
				wordList[wordList.findIndex(e => e.isCurrentWord)].correctWord = false;
			}
		}
	}
